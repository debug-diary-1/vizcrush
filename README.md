...
See the **[quickstart](https://debug-diary-1.github.io/vizcrush/user-guide/quickstart)**, follow the **[streaming viewport adoption path](https://debug-diary-1.github.io/vizcrush/user-guide/streaming-viewport)** for large live time series, or browse all **[43 runnable examples](https://debug-diary-1.github.io/vizcrush/examples/)**.
...
```bash
# Prerequisites: Rust, Node.js 24+, pnpm 12+
pnpm install
pnpm build
pnpm test:all
```
