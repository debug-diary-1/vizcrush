...
/**
 * Single WASM loader for the aggregate crate. The dynamic import is authored
 ...
 */
const loader = createWasmLoader("vizcrush_aggregate", () =>
  new Function("p", "return import(p)")(["..", "wasm", "vizcrush_aggregate.js"].join("/")),
);
